<aside>
  <ul id="sidenav" class="side-nav fixed">
    ...
    <li>
      <a class="waves-effect" href="<?php echo base_url('dashboard'); ?>"><i class="material-icons">home</i>Beranda</a>
    </li>

    <li>
      <a class="waves-effect" href="<?php echo base_url('konfirmasi'); ?>"><i class="material-icons">event</i>Surat Permintaan Konfirmasi</a>
    </li>
	<!--
    <li>
